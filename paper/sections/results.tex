...
\plotfig{figures/combined_invariance_old_new.png}{combined_invariance_old_new.png}{0.92\linewidth}{\textbf{Smaller models do not answer consistently.} Fraction of items whose committed role is identical across all three orthogonal format variants (baseline, target/other position-flip, label-style swap), plotted vs.\ model size for BOTH the old stability models (filled squares, parser-free probability readout) and the new sweep (open circles non-thinking, filled triangles thinking; greedy-readout choice), Wilson $95\%$ CIs, $n$ items annotated. Format-invariance rises sharply with scale across both data generations --- scale, not family or formatting, governs answer stability.}{fig:results-stability}
