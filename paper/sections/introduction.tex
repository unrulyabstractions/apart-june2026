...
answer under cosmetic reformatting while the large model does not. \emph{Reasoning commits
at one token:} forking the chain of thought of the thinking models, every model from
$0.8$B to $9$B resolves its answer at a single decisive forking token (change-point Bayes
factor ${\approx}10^{9}$). We stress that
