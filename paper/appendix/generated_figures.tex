...
\emph{non-thinking} probability method: the committed choice is the role (target /
other / unknown) whose stored option probability is highest, read directly from the
role-ordered probability vector. This signal never passes through the free-text answer
