...
_FAMILY_MARKERS: list[tuple[str, ChatTemplateMarkers]] = [
    ("gemma", ChatTemplateMarkers(turn_marker="<start_of_turn>")),
    ("llama", ChatTemplateMarkers(turn_marker="<|start_header_id|>")),
...
_DEFAULT_MARKERS = ChatTemplateMarkers(turn_marker="<|im_start|>")
