"""Knobs for how each prompt is queried at both risk-assessment levels."""
...
@dataclass
class RiskQueryConfig(BaseSchema):
    """Per-run settings shared across every prompt in a dataset."""

    n_thinking_samples: int = 8  # generations drawn per prompt for the thinking level
    ...
    do_non_thinking: bool = True  # teacher-forced calibrated probability
    do_thinking: bool = True  # sampled free-form reasoning
