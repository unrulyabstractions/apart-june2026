...
| `plot_steering_test.py` | **driver**: cross-model figure (held-out vs fitted curves, no-steering/control/scaffold marks; minimal text — short per-model titles, no suptitle/how-to-read) -> `figures/abstention_vs_alpha.png` and `figures/unknown_prob_vs_alpha.png` |
